# -*- coding: utf-8 -*-
#
# fritzctl documentation build configuration file, created by
# sphinx-quickstart on Mon Jul 11 12:03:45 2016.
#
...
def add_directive_header(self, sig):
    ...
    if not self.options.annotation and (not hasattr(self.object,"__len__") or len(self.object)<=5):
        try:
        ...
        pass
    elif (hasattr(self.object,"__len__") and len(self.object)<=5):
...
latex_documents = [
  (master_doc, 'fritzctl.tex', u'fritzctl Documentation',
   u'AVM', 'manual'),
]
...
man_pages = [
    (master_doc, 'fritzctl', u'fritzctl Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'fritzctl', u'fritzctl Documentation',
   author, 'fritzctl', 'Python Client Library for the AVM TR64 API',
   'Miscellaneous'),
]
